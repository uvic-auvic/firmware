...
APP_OBJS += \
$(OUTPUT_DIR)/obj/bootloader/startup/system_stm32f0xx.o \
$(OUTPUT_DIR)/obj/bootloader/startup/startup_stm32.o \
...
$(OUTPUT_DIR)/obj/bootloader/startup/%.o: $(CODE_DIR)/startup/%.c
	...
	# Each subdirectory must supply rules for building sources it contributes
$(OUTPUT_DIR)/obj/bootloader/startup/startup_stm32.o: $(CODE_DIR)/startup/startup_stm32.s
